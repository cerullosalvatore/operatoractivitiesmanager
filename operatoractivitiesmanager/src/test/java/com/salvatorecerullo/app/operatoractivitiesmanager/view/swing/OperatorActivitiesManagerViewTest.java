...
public class OperatorActivitiesManagerViewTest extends AssertJSwingJUnitTestCase{
	...
	protected void onSetUp() throws Exception {
		//Our frame and the fixture will be recreated for each test method so that we always start with a fresh user interface.
		...
		//FrameFixture will then be used to interact with our view’s controls (labels, text fields, buttons, etc.).
